...
from levi_cli.llm import ModelCapability
from levi_cli.soul import (
    LLMNotSet,
    LLMNotSupported,
    MaxStepsReached,
    Soul,
...
from levi_cli.soul.agent import Agent, Runtime
from levi_cli.soul.compaction import SimpleCompaction
from levi_cli.soul.context import Context
from levi_cli.soul.message import check_message, system, tool_result_to_message
from levi_cli.tools.tmail import NAME as SendTMail_NAME
from levi_cli.tools.utils import ToolRejectedError
...
class LeviSoul:
    ...
    def __init__(
        ...
        *,
        ...
        self._time_machine = agent.runtime.time_machine
    ...
    async def _agent_loop(self):
        ...
        while True:
            ...
            try:
                ...
                self._time_machine.set_n_checkpoints(self._context.n_checkpoints)
    ...
    async def _step(self) -> bool:
        ...
        if rejected:
            _ = self._time_machine.fetch_pending_tmail()
            return True

        # handle pending T-Mail
        if tmail := self._time_machine.fetch_pending_tmail():
            assert tmail.checkpoint_id >= 0, "TimeMachine guarantees checkpoint_id >= 0"
            assert tmail.checkpoint_id < self._context.n_checkpoints, (
                "TimeMachine guarantees checkpoint_id < n_checkpoints"
            )
            ...
            raise BackToTheFuture(
                ...
                [
                    Message(
                        ...
                        content=[
                            system(
                                "You just got a T-Mail from your future self. "
                                "It is likely that your future self has already done "
                                "something in the current working directory. Please read "
                                "the T-Mail and decide what to do next. You MUST NEVER "
