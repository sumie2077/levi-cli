...
_LEVI_ANSI_THEME_NAME = "levi-ansi"
_LEVI_ANSI_THEME = ANSISyntaxTheme(
    {
...
def _resolve_code_theme(theme: str) -> str | SyntaxTheme:
    if theme.lower() == _LEVI_ANSI_THEME_NAME:
        return _LEVI_ANSI_THEME
    return theme
...
class MarkdownContext:
    ...
    def __init__(
        ...
        inline_code_theme: str | SyntaxTheme = _LEVI_ANSI_THEME_NAME,
    ) -> None:
...
class Markdown(JupyterMixin):
    ...
    Args:
        ...
        code_theme (str, optional): Pygments theme for code blocks. Defaults to "levi-ansi".
    ...
    def __init__(
        self,
        markup: str,
        code_theme: str = _LEVI_ANSI_THEME_NAME,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--code-theme",
        dest="code_theme",
        default=_LEVI_ANSI_THEME_NAME,
        help='code theme (pygments name or "levi-ansi")',
    )
    parser.add_argument(
        "-i",
        "--inline-code-lexer",
